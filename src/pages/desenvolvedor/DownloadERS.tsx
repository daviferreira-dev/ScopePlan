 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 .abnt-file-list { list-style: none; padding-left: 0; margin-top: 8px; }

 .abnt-file-item { display: flex; align-items: baseline; gap: 8px; margin-bottom: 6px; font-size: 12pt; color: #000; }

 .abnt-file-bullet { font-size: 12pt; color: #000; }

 .abnt-file-name { font-weight: normal; color: #000; }

 .abnt-file-size { color: #333; font-size: 10pt; margin-left: 8px; }

 .abnt-no-files { font-style: italic; color: #444; font-size: 12pt; margin-left: 20px; }
...
const mockUser = { name: "Diego Santos", role: "Desenvolvedor", initials: "DS" };
