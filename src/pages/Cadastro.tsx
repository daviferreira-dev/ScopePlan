...
type Role = "analista" | "cliente" | "desenvolvedor" | "gestor";
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="field">
              ...
              <div className="input-wrapper">
                ...
                <input type="text" placeholder="Seu nome completo" value={nome} onChange={(e) => setNome(e.target.value)} autoComplete="name" required disabled={loading} />
              </div>
            </div>
            ...
            <div className="field">
              ...
              <div className="input-wrapper">
                ...
                <input type="email" placeholder="email@gmail.com" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" required disabled={loading} />
              </div>
            </div>
            ...
            <div className="field">
              ...
              <div className="input-wrapper">
                ...
                <input type={showPassword ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="new-password" required disabled={loading} />
            ...
            <div className="divider">
              ...
              <span className="divider-label">Tipo de Conta</span>
              <div className="divider-line" />
            </div>

            <div className="quick-access">
                <button type="button" className={`btn-quick ${role === "analista" ? "active" : ""}`} onClick={() => setRole("analista")} disabled={loading}>
                    Analista
                </button>
                <button type="button" className={`btn-quick ${role === "cliente" ? "active" : ""}`} onClick={() => setRole("cliente")} disabled={loading}>
                    Cliente
                </button>
                <button type="button" className={`btn-quick ${role === "desenvolvedor" ? "active" : ""}`} onClick={() => setRole("desenvolvedor")} disabled={loading}>
                    Desenvolvedor
                </button>
                <button type="button" className={`btn-quick ${role === "gestor" ? "active" : ""}`} onClick={() => setRole("gestor")} disabled={loading}>
                    Gestor
                </button>
            </div>
