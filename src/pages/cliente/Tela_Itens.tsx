 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 box-shadow: 0 4px 14px rgba(45,122,64,0.25); white-space: nowrap;
 }
 ...
 display: flex; flex-direction: column; gap: 0; min-height: 110px; position: relative;
 }
 ...
 .topic-icon {
 width: 32px; height: 32px; border-radius: 8px; background: var(--progress-bg);
...
const MOCK_REQUIREMENTS_RF: Requirement[] = [
 {
   id: "RF-001", status: "Aprovado", title: "Autenticação Múltipla",
   ...
   commentsCount: 3, modifiedBy: "ANA SILVA", modifiedDate: "12/05/2026", modifiedTime: "16:30",
 },
 {
   ...
   commentsCount: 5, modifiedBy: "CARLOS MELO", modifiedDate: "10/05/2026", modifiedTime: "08:15",
 },
 {
   id: "RF-003", status: "Pendente", title: "Dashboard Executivo",
   ...
   commentsCount: 16, modifiedBy: "ANA SILVA", modifiedDate: "08/05/2026", modifiedTime: "11:00",
 },
 {
   id: "RF-004", status: "Pendente", title: "Cadastro de Fornecedores",
   description: "O sistema deve permitir o cadastro completo de fornecedores com CNPJ, endereço, contatos e documentos anexos, validando a integridade dos dados informados.",
   commentsCount: 2, modifiedBy: "CARLOS MELO", modifiedDate: "09/05/2026", modifiedTime: "14:20",
 },
 {
   id: "RF-005", status: "Pendente", title: "Notificações em Tempo Real",
   description: "O sistema deve enviar notificações push e por e-mail quando ocorrerem eventos críticos como aprovações pendentes, prazos próximos ou alterações em requisitos.",
   commentsCount: 8, modifiedBy: "ANA SILVA", modifiedDate: "11/05/2026", modifiedTime: "09:45",
 },
];

const MOCK_REQUIREMENTS_RN: Requirement[] = [
 {
   id: "RN-001", status: "Pendente", title: "Aprovação de Requisitos",
   description: "Todo requisito deve ser validado pelo cliente antes de ser considerado aprovado. O cliente pode aprovar, reprovar ou enviar observações para revisão.",
   commentsCount: 4, modifiedBy: "ANA SILVA", modifiedDate: "07/05/2026", modifiedTime: "10:00",
 },
 {
   id: "RN-002", status: "Pendente", title: "Regra de Bloqueio de Exclusão",
   description: "Nenhum requisito aprovado pode ser excluído sem autorização formal do cliente e registro na trilha de auditoria.",
   commentsCount: 6, modifiedBy: "CARLOS MELO", modifiedDate: "06/05/2026", modifiedTime: "15:30",
 },
];

const MOCK_REQUIREMENTS_RNF: Requirement[] = [
 {
   id: "RNF-001", status: "Pendente", title: "Performance de Consultas",
   description: "As consultas ao banco de dados devem retornar resultados em menos de 2 segundos para volumes de até 100.000 registros.",
   commentsCount: 3, modifiedBy: "ANA SILVA", modifiedDate: "05/05/2026", modifiedTime: "11:15",
 },
 {
   id: "RNF-002", status: "Em Revisão", title: "Disponibilidade do Sistema",
   description: "O sistema deve garantir disponibilidade de 99,5% mensais, com janela de manutenção programada aos domingos das 02h às 06h.",
   commentsCount: 10, modifiedBy: "CARLOS MELO", modifiedDate: "04/05/2026", modifiedTime: "16:00",
 },
 {
   id: "RNF-003", status: "Pendente", title: "Compatibilidade de Navegadores",
   description: "A aplicação deve ser compatível com as duas últimas versões estáveis dos navegadores Chrome, Firefox, Edge e Safari.",
   commentsCount: 2, modifiedBy: "ANA SILVA", modifiedDate: "03/05/2026", modifiedTime: "08:30",
 },
];
