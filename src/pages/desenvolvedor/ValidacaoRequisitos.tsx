 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 /* Observation section (view-only: shows existing observations, no input) */
 .req-observations {
...
export default function ValidacaoRequisitos({ project, topic, onBack }: Props) {
  const [requirements] = useState<Requirement[]>(topic.requirements || []);
              ...
              {requirements.length > 0 ? (
                requirements.map((req) => (
                  <div className="req-card" key={req.id}>
                    ...
                    {/* Observações existentes (view-only: sem input) */}
                ...
                <div className="empty-state">
                  ...
                  <p>Este tópico ainda não possui requisitos para visualização.</p>
                </div>
              )}
