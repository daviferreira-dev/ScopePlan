 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 .main { width: 100vw; }
 .topbar { padding: 20px 18px; gap: 10px; }
                    ...
                    {activePage === "projetos" && (
                        <>
                            ...
                            <div className="content">
                                {/* Stats pills — only when data is loaded */}
                                ...
                                {loading ? (
                                    ...
                                    <div className="empty-state">
                                        ...
                                        <div className="empty-subtitle">
                                            Os projetos criados pelo analista aparecerão aqui para validação.
                                        </div>
                                    </div>
                                ) : (
                                                ...
                                                <div className="project-card" key={p.id} onClick={() => setSelectedProject(p)}>
                                                    ...
                                                    <div className="card-footer">
                                                        <div className="card-updated">
                                                            ...
                                                            Atualizado {formatUpdatedDate(p.atualizado_em)}
                                                        </div>
