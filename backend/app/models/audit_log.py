...
class AuditLog(db.Model):
 ...
 acao = db.Column(db.String(50), nullable=False) # criacao, atualizacao, aprovacao, rejeicao, observacao, download, exclusao, login, logout, submissao_revisao, validacao
 entidade_tipo = db.Column(db.String(50), nullable=False) # projeto, requisito, validacao, usuario
